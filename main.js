...
function init()
{
    ...
    InformationAboutThePlanets('sprites/mercuryI.png'  );
    InformationAboutThePlanets('sprites/venusI.png'  );
    InformationAboutThePlanets('sprites/earthI.png'  );
    InformationAboutThePlanets('sprites/marsI.png'  );

    addSprite( 'sprites/mercury.png' );
    addSprite( 'sprites/venus.png' );
    addSprite( 'sprites/earth.png' );
    addSprite( 'sprites/mars.png' );
    addSprite( 'sprites/moon.png' );
    addSprite( 'sprites/Sun.png' );
    planetName[5].position.set(0,-11,5);
    planetName[5].scale.set(20, 20, 5);
    sputnicName.splice(3,1);
    ...
    for (var i = 0; i < planets.length; i++) 
        {
            ...
            *///установка m в качестве матрицы преобразований объекта object
            if(planets[i].moon != null)
            {
                ...
                m11.makeRotationY( planets[2].moon.angle );
                m22.setPosition(new THREE.Vector3(planets[2].moon.x1, 0, 0));
                m33.makeRotationY( planets[2].moon.angleaxis );
              
                m44.setPosition(new THREE.Vector3(planets[2].moon.x2 * Math.cos(-planets[2].moon.angle2+b), 0, planets[2].moon.x2 * Math.sin(-planets[2].moon.angle2+b)));
                ...
                moonName.multiplyMatrices(m11,m22);
                moonName.multiplyMatrices(moonName,m33);
                moonName.multiplyMatrices(moonName,m44);
                ...
                var newcoordsSprite = new THREE.Vector3();
                newcoordsSprite.setFromMatrixPosition(moonName);
                sputnicName[3].position.set(newcoordsSprite.x,newcoordsSprite.y-2,newcoordsSprite.z);
